        ...
        <nav className="bg-primary flex item-center justify-between p-4">
          <div className="flex lg:flex-1">
            <Link href={"/"}>
              ...
              <Image className='w-auto h-auto' width={40} height={40} src={'/logo.png'} alt='Logo'></Image>   
            </Link>
            
          </div>
          
          <div className="flex items-center">
            <Link href={`${session ? '/my-listings' : 'api/auth/signin'} `} 
...

                {
                  ...
                  <>
                    <DropdownMenuItem className='font-bold'>
                      <Link href={`${session ? '/my-rented-items' : 'api/auth/signin'} `} >
                          Rented Items
                      </Link>
                    </DropdownMenuItem>
